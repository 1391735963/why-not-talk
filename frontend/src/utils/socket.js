...
import { startVideoChat, createChatList } from "./userList";
import {
  stopVideoStream,
  getOffer,
  getAnswer,
...
function socketOpen(data) {
  ...
  localStorage.setItem("connectUri", connectUri.value);
  login.value = true;
  chatBox.value = false;
  videoChat.value = true;
  myName.value = localStorage.token;
}
...
export { initSocket, breakVideoConnect, socket };
